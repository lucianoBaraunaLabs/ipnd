...
frase_lacunas_resposta = {
    ...
    "facil": {
        "frase": "O __1__ do pé __2__ pedro é __3__",
        "lacunas": ["__1__", "__2__", "__3__"],
        "respostas":["peito", "do",  "preto" ]
    },
    "medio": {
...
def pergunta_resposta(frase, lista_lacunas, lista_respostas, indice_atual, lacuna_atual):
    """
    ...
    return frase.replace(lista_lacunas[indice_atual], lista_respostas[indice_atual])
...
def start():
    ...
    for indice_atual, lacuna_atual in enumerate(lista_lacunas):
        resposta = pergunta_resposta(frase, lista_lacunas, lista_respostas, indice_atual, lacuna_atual)
        print resposta
